/****************************************************************************
** Meta object code from reading C++ file 'mainapp.hh'
**
...
#error "The header file 'mainapp.hh' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainApp_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MainApp_t qt_meta_stringdata_MainApp = {
    {
QT_MOC_LITERAL(0, 0, 7), // "MainApp"
QT_MOC_LITERAL(1, 8, 27), // "on_fileSelectButton_clicked"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 24) // "on_processButton_clicked"

    },
    "MainApp\0on_fileSelectButton_clicked\0"
    "\0on_processButton_clicked"
};
...
void MainApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_processButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
